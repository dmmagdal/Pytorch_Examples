		...
		for epoch in range(args.epochs):
			with tqdm(range(len(train_dataset))) as pbar:
				for i, imgs in zip(pbar, train_dataset):
					...
					perceptual_rec_loss = args.perceptual_loss *\
				...
				torch.save(
					...
					os.path.join(
						"checkpoints", f"vqgan_epoch_{epoch}.pt"
					)
				)
...
if __name__ == '__main__':
	...
	args.dataset_path = r"C:\Users\\Max\Documents\GitHub\Pytorch_Examples\VQGAN\flowers"
