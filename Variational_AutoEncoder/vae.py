...
def main():
	...
	class Sampling(layers.Layer):
		...
		def call(self, inputs):
			...
			epsilon = tf.keras.initializers.RandomNormal()(shape=(batch, dim))
	...
	class VAE(keras.Model):
		def __init__(self, encoder, decoder, **kwargs):
			...
			self.k1_loss_tracker = keras.metrics.Mean(name="k1_loss")
	...
	# Display how the latent space clusters different digit
	# classes.
	def plot_label_clusters(vae, data, labels):
		# Display a 2D plot of the digit classes in the latent
		# space.
